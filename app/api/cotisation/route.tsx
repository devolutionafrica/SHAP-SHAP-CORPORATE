...
export async function GET(request: NextRequest) {
  ...
  const dateFormatFin = `${dateFinSplit[2]}${dateFinSplit[1]}${dateFinSplit[0]}`;
  console.log("formatted dateDeb", dateDeb);
  ...
  try {
    ...
    const result = await pool
      ...
      .input("DATE_DEBUT", sql.Int, dateDeb)
      .input("DATE_FIN", sql.Int, dateFin)
      .query(
