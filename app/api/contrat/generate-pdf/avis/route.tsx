  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <div class="section-title">Evolution au cours de l'exercice ${date} (en XOF)</div>
        <table>
          <tr><td>- Montant du capital acquis au 01/01/2024 :</td><td class="text-right">${reportData.evolution2024.capitalAcquiredJan1}</td></tr>
          <tr><td>- Cumul des Cotisations brutes de l'exercice ${date} :</td><td class="text-right">${reportData.evolution2024.grossContributions2024}</td></tr>
          <tr><td>- Cumul des Cotisations nettes de l'exercice ${date} :</td><td class="text-right">${reportData.evolution2024.netContributions2024}</td></tr>
          <tr><td>- Versement exceptionnel ou régularisation de primes effectué en ${date} :</td><td class="text-right">${reportData.evolution2024.exceptionalPayment2024}</td></tr>
          <tr><td>- Interêts nets acquis au cours de l'exercice ${date} :</td><td class="text-right">${reportData.evolution2024.netInterestAcquired2024}</td></tr>
          <tr><td>- Participations aux bénéfices de l'année ${date} :</td><td class="text-right">${reportData.evolution2024.profitSharing2023}</td></tr>
          <tr><td>- Rachats partiels, régularisations d'avances ou primes impayés en ${date} :</td><td class="text-right">${reportData.evolution2024.partialRedemptions2024}</td></tr>
          <tr><td>- Frais sur actif gérés de l'exercice ${date} :</td><td class="text-right">${reportData.evolution2024.assetManagementFees2024}</td></tr>
          <tr><td><strong>CAPITAL ACQUIS AU 31/12/${date} :</strong></td><td class="text-right"><strong>${reportData.evolution2024.capitalAcquiredDec31}</strong></td></tr>
        </table>
