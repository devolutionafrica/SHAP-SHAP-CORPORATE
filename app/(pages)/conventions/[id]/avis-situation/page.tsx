...
const ReportViewerAndDownloader = () => {
  ...
  const apiUrl = `/api/corporate/${id}/generate-pdf/avis?ANNEE=${selectedYear}`;
  ...
  return (
    ...
    >
      ...
      {!loading && error && (
        <div className="p-8 backdrop-blur-sm my-8 max-w-2xl mx-auto rounded-lg text-[black] flex flex-col gap-8 items-center ">
          <div>
            <Image src={NotFound} alt="Not Found" width={200} />
          </div>
          <div className="font-bold text-lg">
            Aucun avis n'a été trouvé pour cette convention pour la date{" "}
            {selectedYear}.
          </div>
        </div>
      )}
